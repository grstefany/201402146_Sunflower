...
val md_theme_light_onPrimary = Color(0xFFFFF5A0)
val md_theme_light_primaryContainer = Color(0xFF6CE4F3)
val md_theme_light_onPrimaryContainer = Color(0xFFFFEB3B)
val md_theme_light_secondary = Color(0xFF55624C)
val md_theme_light_onSecondary = Color(0xFFFFF5A0)
val md_theme_light_secondaryContainer = Color(0xFF85D9E4)
val md_theme_light_onSecondaryContainer = Color(0xFF131F0D)
val md_theme_light_tertiary = Color(0xFF386667)
val md_theme_light_onTertiary = Color(0xFFFFF5A0)
...
val md_theme_light_onError = Color(0xFFFFF5A0)
val md_theme_light_onErrorContainer = Color(0xFF410002)
val md_theme_light_background = Color(0xFFFFF5A0)
val md_theme_light_onBackground = Color(0xFF1A1C18)
val md_theme_light_surface = Color(0xFFFFF5A0)
